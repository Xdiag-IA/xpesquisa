...
3. Brasil: escolher uma fonte oficial (ex.: CONITEC), registrar termos, forma permitida de acesso e versão documental antes de desenvolver o conector. Distinguir regulação, diretriz e estudo brasileiro; não inferir país de população pelo país de periódico.
