...
3. Brasil: base CFM/CRMs e publicações SBH/CBR integradas na versão 0.2. Versão 0.3 acrescenta SBUS e descoberta indireta de depósitos SciELO no Crossref. Próximo: viabilizar API BVS/LILACS com acesso autorizado, busca direta SciELO, legislação federal e demais sociedades. Bloqueios observados e requisitos estão em docs/research/expansion-0.3.md. Distinguir regulação, diretriz e estudo brasileiro; não inferir país de população pelo país de periódico ou da instituição.
